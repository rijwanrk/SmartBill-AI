      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <Link to="/" className="flex items-center space-x-3 mb-3">
              ...
              <span className="text-lg font-bold">SmartBill AI</span>
            </Link>
            <p className="text-gray-400 max-w-sm">
              Smart, lightning-fast AI invoicing — built to simplify billing,
              boost productivity, and let you focus on what matters.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 flex items-center space-x-3">
              <SocialLink href="https://www.linkedin.com/in/rizwan-khan-640417247/">
        ...
        <div className="border-t border-gray-800 py-6 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-gray-400">
            <p className="text-sm">
              © 2026 Invoice With AI. Built by Rizwan khan.
            </p>
